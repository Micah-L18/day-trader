...
/** The order-entry form. Shared by the floating ticket and the detached window.
 * Every submit goes through window.api.orders.submit → SafetyGate. */
export function TicketForm(): ReactElement {
